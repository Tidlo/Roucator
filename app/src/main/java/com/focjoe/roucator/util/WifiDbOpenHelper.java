...
public class WifiDbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + SavedWifiEntry.TABLE_NAME + " (" +
                    ...
                    SavedWifiEntry.COLUMN_NAME_SYNCED + " VARCHAR(10)" +
                    ")";
    ...
    private void initDb(SQLiteDatabase db) {
        ...
        values.put(SavedWifiEntry.COLUMN_NAME_SYNCED, "true");

        db.insert(SavedWifiEntry.TABLE_NAME, null, values);

        db.execSQL("INSERT INTO wifi VALUES(NULL, ?,?,?,?)", new Object[]{"Fancy", "nopass", "asdasdasd", "false"});
        db.execSQL("INSERT INTO wifi VALUES(NULL, ?,?,?,?)", new Object[]{"asdasd", "nopass", "asdasdasd", "false"});
        db.execSQL("INSERT INTO wifi VALUES(NULL, ?,?,?,?)", new Object[]{"fghfghf", "nopass", "asdasdasd", "false"});
    }
}
